...
ALTER TABLE PLACE_REVIEW
ADD CONSTRAINT FK_PLAN_NUM2 FOREIGN KEY(PLAN_NUM) REFERENCES PLANNER(PLAN_NUM) ON DELETE CASCADE;
...
FOR EACH ROW
BEGIN
    INSERT INTO PLANNER (PLAN_NUM, PLAN_TITLE, PLAN_DATE, PLAN_DAYS, M_ID, TL_NUM)
    VALUES (PLAN_NUM_SEQ.NEXTVAL, '환영합니다', SYSDATE, 1, :NEW.M_ID, 1);
END;
