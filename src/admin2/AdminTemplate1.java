...
public class AdminTemplate1 extends JFrame{
	...
	/*jpWest Panels*/ JPanel jpAdminHome, jpPlaceEdit, jpUserEdit, jpReviewEdit;
	/*jpWest Buttons */ JButton adminHomeBtn,placeEditBtn , userEditBtn, reviewEditBtn ;
...
//		reviewEditBtn.setBackground(Color.decode("#393646"));
		...
		//jpWest.add(panel)
		jpWest.add(jpAdminHome);
		jpWest.add(jpPlaceEdit);
		jpWest.add(jpUserEdit);
		jpWest.add(jpReviewEdit);
